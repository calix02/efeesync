...
const AddProgramCard = React.forwardRef(({animate, onAnimationEnd,onClose}, ref) =>{
    ...
    return( 
        ...
        onAnimationEnd={onAnimationEnd}>
            ...
            <div className="mt-6">
                ...
                <input type="text" onChange={changeProgramCode} value={programCode} className="border-2 px-2 border-[#174515] h-8 rounded-md w-[100%] mb-4" /> <br />
                <label>Program Name:</label><br />
                <input type="text" onChange={changeProgramName} value={programName} className="border-2 px-2 border-[#174515] h-8 rounded-md w-[100%] mb-4" /> <br />
                 <label>College Code:</label><br />
                <input type="text" onChange={changeCollegeCode}  value={collegeCode} className="border-2 px-2 border-[#174515] h-8 rounded-md w-[100%] mb-4" /> <br />
                 
            </div>
            
                <button onClick={()=>{addProgram(); onClose();}} className="bg-[#174515] w-[100%] rounded-md cursor-pointer text-white h-8">Add Program</button>
