...
function CommunityService({communityService, animate, formatDateStr}){
    return(
        <div className={` ${animate} w-[100%] h-120 border-2 text-amber-700 shadow-[2px_2px_3px_grey] bg-white rounded-lg border-[#F1A917] px-6`}>
            ...
            <div className="w-[100%] hover:scale-103 transition duration-300  min-h-25 py-2 bg-[#fcfcfc] flex items-center border shadow-[2px_2px_2px_gray] px-4 rounded-lg border-[#e0e0e0] mt-3">
