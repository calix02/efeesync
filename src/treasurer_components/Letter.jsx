  ...
  return (
    ...
    >
      ...
      <div className="text-sm text-[#000] mt-8 flex flex-col">
        ...
        <span>Absence Date: {formatDateStr(data.event_date)}</span>
        <span>Submitted Date: {formatDateStr(data.submitted_at)}</span>

        <span className="mt-3 font-semibold">Attachment</span>
