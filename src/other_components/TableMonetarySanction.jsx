            ...
            {pageData.map((s, idx) => (
              <tr key={idx} className="border-b border-[#0505057a] ">
                ...
                <td className="flex lg:flex-row flex-col gap-2 justify-center py-2">
                  <span onClick={collectSanction} className="material-symbols-outlined cursor-pointer text-[#65A810] bg-white  shadow-[2px_2px_1px_grey] rounded-[5px] border border-[#65A810] px-[2px]">
                    payments
                  </span>
                </td>
              </tr>
