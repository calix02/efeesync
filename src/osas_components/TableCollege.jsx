...
function TableCollege({ code = "osas", colleges = [] , update}) {
  ...
  return (
    ...
    <div className={`w-full ${animate} flex flex-col gap-6`}>
      {/* table wrapper */}
      <div className="lg:ml-70 bg-white border-1 font-[family-name:Arial] lg:text-sm text-xs border-[#174515] text-black flex-grow p-5 mt-3 rounded-lg shadow-[2px_2px_2px_grey]">
