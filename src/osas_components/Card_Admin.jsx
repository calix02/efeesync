...
function Card_Admin(props){
    ...
    */
    return(
         <div style={{ color:props.color, background:props.color}} className={` relative text-[#F6FFB1] bg-[#ACD8A7]  rounded-sm py-1 shadow-gray-200 overflow-hidden `}>
                <img className='absolute w-35 opacity-50 right-[-70px] top-2' src={props.logo} alt="" />
                <span className="flex text-black gap-2 items-center">
                ...
                <div className='flex justify-between px-8 items-center'>
                    ...
                    <div className='w-40 bg-white text-black py-1 text-center rounded-md z-10 text-xl font-bold font-poppins'>₱ {props.budget}</div>
                </div>
                <div className='flex text-[#000] justify-between px-8 items-center mt-4'>
                ...
                <div className='flex text-[#000] justify-between px-8 items-center '>
                    <span className='text-sm font-inter '>Cash on Bank:</span>
                    <div className='w-40 text-left font-inter font-bold text-sm'>₱ {props.cashBank}</div>
                </div>
                <div className='flex text-[#000] justify-between px-8 mb-4 items-center mt-3'>
                    <span className='text-sm font-inter '>Expenses:</span>
                    <div className='w-40 text-left font-inter font-bold text-sm'>₱ {props.expenses}</div>
                </div>
        </div>
    );
}
