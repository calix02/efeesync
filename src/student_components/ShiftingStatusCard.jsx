...
function ShiftingStatusCard({status}){
    const color = 
    ...
    : 'bg-white'
    return(
        <div className="w-147 h-55 px-6 bg-white shadow-[2px_2px_3px_grey] border-1 border-[#621668] rounded-lg">
            <div className="mt-4 ">
            ...
            <div className="flex justify-start gap-2 mt-4  text-sm">
                <button className="w-20 h-6 border-1 rounded-lg bg-[#E6EDFD] text-[#2F6FDD]">Edit</button>
