...
import TableStudent from '../council_components/TableStudent.jsx';
import AddStudentCard from '../council_components/AddStudentCard.jsx';
import UpdateStudentCard from '../council_components/UpdateStudentCard.jsx';
         ...
         {showUpdateStudentCard &&
            ...
            <CITHeader logoCouncil={it} titleCouncil = "College Of Information Teachnology" abb="CIT Council" />
             <div className="w-screen h-screen bg-[#fafafa] absolute z-[-1] overflow-y-auto overflow-x-auto ">
                ...
                <div className='lg:ml-[290px] mt-[100px] lg:flex lg:justify-between px-[10px]'>
