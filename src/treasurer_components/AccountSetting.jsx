...
function AccountSetting({upload,accName,accRole,accEmail,profile,changePass,changeInfo,code}){
    const animate = "card-In";
     const colors = {
      ...
      const hover = hovers[code] || "hover:bg-[#174515]";


    return(
        <div className={`w-[100%] ${animate} ${color} py-12 px-8 font-[family-name:Arial]  bg-white border-black border-1 rounded-xl shadow-[3px_3px_2px_grey]`}>
