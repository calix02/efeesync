...
function StudentTreasurerCard(){
    return(
        <div className=" lg:w-100 md:w-150 font-[family-name:Arial] rounded-lg h-92">
            <div className="flex justify-between mt-3">
                <h3 className="font-semibold text-lg">Student Council Treasurer</h3>
                <button className="border-1 cursor-pointer border-black w-30 text-xs rounded-md "><i className="fa-solid fa-plus"></i>Add Treasurer</button>
            </div>
