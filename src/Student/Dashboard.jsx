    ...
    return(
        ...
        <div className="w-screen h-screen bg-[#F8F8F8] absolute z-[-1] overflow-y-auto overflow-x-auto ">
            <div className="mt-[110px] lg:ml-70">
                <h2 className="text-2xl font-semibold ml-6">Welcome Yummy Bobis!</h2>
            </div>
            <div className="lg:ml-70 flex justify-center gap-8 mt-6">
            ...
            <div className="lg:ml-70 flex justify-center gap-8">
                 <div className="w-135 h-105 bg-white shadow-[2px_2px_3px_#434343,-2px_-2px_3px_#ebe4e4] px-5 border-[#ebe4e4] mt-8 rounded-lg overflow-y-scroll">
