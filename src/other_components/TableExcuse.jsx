          ...
          <tbody>
            {pageData.map((s, idx) => (
              <tr key={idx} className="border-b border-[#0505057a] ">
                ...
                <td>{s.eventName}</td>
                <td>{s.date}</td>
                <td ><button className="bg-white w-27 py-0.25 border-1 text-sm cursor-pointer border-[#621668] text-[#621668] rounded-xl"><i className="fa-regular fa-eye"></i>View Letter</button></td>
                


                <td className="flex lg:flex-row flex-col gap-2 text-lg justify-center py-3">
                  <i className="fa-solid fa-circle-check text-[#70B914]"></i>
                  <i className="fa-solid fa-circle-xmark text-[#DE0004]"></i>
                </td>
              </tr>
            ))}
          </tbody>
