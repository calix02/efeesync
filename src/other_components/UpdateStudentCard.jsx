...
const UpdateStudentCard = React.forwardRef(({animate, onAnimationEnd,onClose}, ref) =>{
    ...
    return( 
        <div ref={ref}   className={` ${animate} lg:w-100 w-80 h-117 px-6 text-sm font-[family-name:Arial] bg-white shadow-[2px_2px_#8A2791,-2px_-2px_white] rounded-lg absolute z-80 inset-0 mx-auto mt-30 `}
        onAnimationEnd={onAnimationEnd}>
            ...
            <div className="mt-4">
                ...
                <button className="bg-[#561b5a] w-[100%] cursor-pointer rounded-md text-white h-8">Update Student</button>
