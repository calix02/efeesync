            ...
            <Header code="osas" logoCouncil={OsasLogo} titleCouncil = "Office of Student Affairs and Services"/>
                <div className="w-screen h-screen bg-[#fafafa] absolute z-[-1] overflow-y-auto overflow-x-auto lg:px-6 md:px-10 px-3">
                    <div className='lg:ml-68 text-[#145712] lg:mt-30 mt-25 lg:flex lg:justify-between items-center'>
                        ...
                        <button onClick={addProgram.toggle} className='hover:bg-[#174515] bg-white lg:mr-4 font-poppins cursor-pointer border border-[#e0e0e0] font-semibold  w-40 h-10 shadow-[2px_2px_2px_gray] text-sm flex justify-center items-center transition duration-300 hover:scale-103 hover:text-white  text-[#174515] rounded-2xl'>
