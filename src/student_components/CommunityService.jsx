...
function CommunityService({communityService, animate, formatDateStr}){
    return(
        <div className={` ${animate} w-[100%] font-poppins overflow-y-scroll pb-5 h-120 border-2 text-amber-700 shadow-[2px_2px_3px_grey] bg-white rounded-lg border-[#F1A917] px-6`}>
            <div className="border-b-4 border-[#F1A917] text-xl pt-3 py-1  font-semibold">
