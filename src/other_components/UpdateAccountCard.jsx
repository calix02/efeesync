...
const UpdateAccountCard = React.forwardRef(({animate, onAnimationEnd,onClose}, ref) =>{
    ...
    return( 
        ...
        onAnimationEnd={onAnimationEnd}>
            ...
            <div className="mt-[15px]">
                ...
                <button className="bg-[#174515] w-[100%] rounded-[5px] text-white py-[5px]"> Update Treasurer</button>
