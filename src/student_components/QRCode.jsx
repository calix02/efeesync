...
const ChangePassword = React.forwardRef(({animate, onAnimationEnd,onClose}, ref) =>{
    ...
    return( 
        <div ref={ref}   className={` ${animate} lg:w-[420px] w-[390px] h-85 px-12 bg-white shadow-[2px_2px_#8A2791,-2px_-2px_white] rounded-[10px] absolute z-50 inset-0 mx-auto mt-40 `}
