          ...
          <tbody>
            {pageData.map((s, idx) => (
              <tr key={idx} className="border-b border-[#0505057a] ">
                ...
                <td>{s.date}</td>
                <td>
                    <button className="bg-white w-27 py-0.25 border-1 text-sm cursor-pointer border-[#621668] text-[#621668] rounded-xl"><i className="fa-regular fa-eye"></i>View Image</button>
