...
const EditCashOnBank = React.forwardRef(({animate, onAnimationEnd,onClose, code, data, bankAmount}, ref) =>{
    const colors = {
    ...
    const [amount, setAmount] = useState(bankAmount?.cashBank);

    useEffect(() => {
        setAmount(bankAmount ?? 0);
    }, [bankAmount]); 
    ...
    return( 
        ...
        onAnimationEnd={onAnimationEnd}>
            ...
            <div className="mt-6 border-b-4 ">
                <span className="font-semibold lg:text-xl text-lg">Edit Cash on Bank</span>
            </div>
            <form onSubmit={(e)=>{
                onClose();
                data(amount);
            ...
            <div className="mt-4">
                <label>Cash Bank Amount:</label><br />
