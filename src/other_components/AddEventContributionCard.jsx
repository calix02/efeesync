...
const AddEventContributionCard = React.forwardRef(({animate, onAnimationEnd,onClose}, ref) =>{
    ...
    return( 
        <div ref={ref}   className={` ${animate} lg:w-100 md:w-100 w-80 h-135 px-6 font-[family-name:Arial] bg-white shadow-[2px_2px_#8A2791,-2px_-2px_white] rounded-lg absolute z-80 inset-0 mx-auto mt-30 `}
        onAnimationEnd={onAnimationEnd}>
            ...
            <div className="mt-4">
                ...
                <input type="text" className="border-2 border-[#8A2791] h-8 rounded-md w-[100%] mb-3" /> <br />
                 ...
                 <div className="border-2 border-[#8A2791] h-8 text-xs rounded-md w-[100%] mb-4 grid grid-cols-[auto_auto_auto_auto] justify-center items-center lg:gap-3 gap-2">
                 ...
                 <div className="border-2 border-[#8A2791] h-8 rounded-md w-[100%] mb-3 grid justify-center items-center">
                    <input type="date" className="lg:w-80 w-60 cursor-pointer " />
               ...
               <select className="border-2 border-[#8A2791] h-8 cursor-pointer rounded-md w-[100%] mb-3 grid grid-cols-[auto_auto] justify-around items-center">
                ...
                <select className="border-2 border-[#8A2791] h-8 rounded-md w-[100%] mb-3 grid grid-cols-[auto_auto] justify-around items-center">
                    <option value=""></option>
            ...
            <div className="relative mt-4">
                <button className="bg-[#8A2791] rounded-md text-white w-35 h-8 absolute right-0">Next</button>
            </div>
        </div>
