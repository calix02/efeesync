...
const AddStudentCard = React.forwardRef(({animate, onAnimationEnd,onClose,currentUser,reloadStudents, code}, ref) =>{
    const colors = {
    ...
    return( 
        <div ref={ref}   className={` ${animate} ${color} lg:w-100 w-80 h-115 px-6 font-[family-name:Arial] lg:text-sm text-xs bg-white  rounded-lg  z-80 inset-0 mx-auto `}
