...
const UpdateStudentOsasCard = React.forwardRef(({animate, onAnimationEnd,onClose}, ref) =>{
    ...
    return( 
        ...
        onAnimationEnd={onAnimationEnd}>
            ...
            <div className="mt-6 border-b-4 border-[#174515]">
                <span className="text-[#174515] font-semibold text-2xl">Update Student</span>
            </div>
            <div className="mt-[15px]">
                ...
                <button className="bg-[#174515] w-[100%] rounded-[5px] text-white py-[5px]">Update Student</button>
