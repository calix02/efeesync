  ...
  return (
    <>
      <header className={` flex  bg-white fixed top-0 w-screen h-20 lg:z-20 md:z-40 z-60 rounded-xl shadow-[2px_2px_4px_gray]  items-center ${color}`}>
        ...
        <span >
          <h2 className="lg:text-2xl md:text-lg text-sm  font-bold font-poppins ml-2">{title}</h2>
        </span>
      ...
      {/* 
        ...
        */}
          ...
          <span onClick={() => { clickedAccBar(); account.toggle(); }}  className={`hidden px-3 font-poppins text-sm font-semibold rounded-xl hover:scale-107  ${hoverColor} ${color} cursor-pointer transiton duration-150   lg:flex items-center hover:text-white`}>
